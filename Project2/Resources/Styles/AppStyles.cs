...
namespace Project2
{
    public class AppStyles
    {
        public static ResourceDictionary Default => new ResourceDictionary {
            ...
            // "Border" - (DÜZELTÝLDÝ: Ýki stil birleþtirildi)
            new Style<Border>(e => e
                .Stroke(e => e.OnLight(AppColors.Gray200).OnDark(AppColors.Gray500)) // Renk ayarý
                .StrokeShape(new RoundRectangle().CornerRadius(8)) // Þekil ayarý (Yuvarlak köþe)
                .StrokeThickness(1)),
            ...
            // --- BURADAKÝ 2. BORDER SÝLÝNDÝ VE YUKARIYA TAÞINDI ---
